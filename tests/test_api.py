...
class TestSubdomainfinderAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = SubdomainfinderAPIClient(self.api_key)

    @patch('apiverve_subdomainfinder.apiClient.requests.get')
